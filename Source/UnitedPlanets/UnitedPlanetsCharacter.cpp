...
float AUnitedPlanetsCharacter::TakeDamage(float DamageAmount, struct FDamageEvent const& DamageEvent, class AController* EventInstigator, AActor* DamageCauser)
{
...
void AUnitedPlanetsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUnitedPlanetsCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUnitedPlanetsCharacter::TouchStopped);
...
{
	// If UnitedPlanets is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in UnitedPlanets.Build.cs is not automatically propagated
...
void AUnitedPlanetsCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AUnitedPlanetsCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
